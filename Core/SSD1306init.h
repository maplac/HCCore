...
static const uint8_t MEM_TYPE Adafruit128x64Invertedinit[] = {
    // Init sequence for Adafruit 128x64 OLED module
    SSD1306_DISPLAYOFF,
    SSD1306_SETDISPLAYCLOCKDIV, 0x80,  // the suggested ratio 0x80
    SSD1306_SETMULTIPLEX, 0x3F,        // ratio 64
    ...
    SSD1306_CHARGEPUMP, 0x14,          // internal vcc
    SSD1306_MEMORYMODE, 0x02,          // page mode
    SSD1306_SEGREMAP | 0x00,            // column 127 mapped to SEG0
...
/** Initialize a 128x64 oled display. */
static const DevType MEM_TYPE Adafruit128x64Inverted = {
  Adafruit128x64Invertedinit, 
  sizeof(Adafruit128x64Invertedinit),
  128,
  64,
  0
};
