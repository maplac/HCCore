...
private:
     ...
     */
    int writee(const char* s);

private:
    virtual void writeDisplay(uint8_t b, uint8_t mode) = 0;
    virtual void writeDisplayBuffered(uint8_t b, uint8_t mode) = 0;
    virtual void writeDisplayBufferedFlush() = 0;
    virtual void writeDisplayBufferedClear() = 0;
